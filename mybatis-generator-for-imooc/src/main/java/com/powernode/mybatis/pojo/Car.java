...
public class Car {
    ...
    /**风控推荐标志 0否 1是*/
    private Integer riskRecommendTag;
    ...
    /**获取风控推荐标志 0否 1是*/
    public Integer getRiskRecommendTag() {
        return riskRecommendTag;
    }

    /**设置风控推荐标志 0否 1是*/
    public void setRiskRecommendTag(Integer riskRecommendTag) {
        this.riskRecommendTag = riskRecommendTag;
    }
