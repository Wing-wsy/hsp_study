...
> 这个`StudentMapper.xml`文件就相当于`StudentDAO`接口的实现类
...
![](picture/img1/1616147180562.png)
...
> 事务一般用在多个操作，然后保证多个操作同时成功或者同时失败，如果只有一个操作的话那么可以不用使用事务，或者使用自动提交事务。
...
![](picture/img1/1616566868757.png)
...
![](picture/img1/1616577785188.png)
